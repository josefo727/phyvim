...
lsp_installer.on_server_ready(function(server)
  ...
  if server.name == "lua_ls" then
    local lua_opts = require "phyvim.lsp.settings.lua_ls"
  ...
  if server.name == "intelephense" then
    local intelephense_opts = require "phyvim.lsp.settings.intelephense"
    opts = vim.tbl_deep_extend("force", intelephense_opts, opts)
  end

  if server.name == "tsserver" then
    local tsserver_opts = require "phyvim.lsp.settings.tsserver"
